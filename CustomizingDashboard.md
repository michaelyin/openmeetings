You can configure the tabs that are visible by default at bottom of the dashboard. To edit the settings, login as admin and goto Administration > Configuration
